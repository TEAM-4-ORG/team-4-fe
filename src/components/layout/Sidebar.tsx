              ...
              {projects
                ...
                .map((project) => (
                  <Link
                    ...
                    className={`flex items-center space-x-3 rounded-md p-2 hover:bg-gray-200 dark:hover:bg-gray-800 ${router.query.chatId === project.project_id.toString() ? 'bg-gray-200 font-semibold dark:bg-gray-800' : ''}`}
                  >
